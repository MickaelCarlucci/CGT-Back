...
router.route('/newPoll').post(jwtExpirationVerification, controllerWrapper(pollController.createPoll));//!
router.route('/vote/:pollId(\\d+)/:userId(\\d+)').post(jwtExpirationVerification, controllerWrapper(pollController.vote));//!
...
router.route('/delete/:pollId(\\d+)').delete(jwtExpirationVerification, controllerWrapper(pollController.deletePoll));//!
