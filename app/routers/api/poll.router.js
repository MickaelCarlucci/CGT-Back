...
router.route('/newPoll').post(firebaseAuthMiddleware, controllerWrapper(pollController.createPoll));//!
router.route('/vote/:pollId(\\d+)/:userId(\\d+)').post(firebaseAuthMiddleware, controllerWrapper(pollController.vote));//!
...
router.route('/delete/:pollId(\\d+)').delete(firebaseAuthMiddleware, controllerWrapper(pollController.deletePoll));//!
